...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceModel createProduct(ProductServiceModel productServiceModel) {
        ...
        this.modelMapper.map(categoryService.findCategoryById(productServiceModel.getCategories()), category);
    ...
    public ProductServiceModel findProductById(String id) {
        return this.productRepository.findById(id)
                .map(p -> {
                    ...
                    productServiceModel.setCategories(p.getCategories().getName());
    ...
    public ProductServiceModel editProduct(String id, ProductServiceModel productServiceModel) {
        ...
        Category category = new Category();
        category.setName(productServiceModel.getCategories());
    ...
    public List<ProductServiceModel> findAllByCategory(String category) {
        return this.productRepository.findAll()
                .stream()
                .filter(product -> product.getCategories().getName().equals(category))
